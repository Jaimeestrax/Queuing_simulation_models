...
def mostrar_menu_calculos():
    ...
    print("5. Número esperado de clientes en cola (Lq)")
    print("6. Número esperado de clientes en el sistema (L)")
    ...
    print("11. Probabilidad acumulada (desde n hasta m clientes)")
    ...
    while True:
        try:
            ...
            if 0 <= opcion <= 11:
                ...
                print("Opción no válida. Ingrese un número entre 0 y 11")
        except ValueError:
